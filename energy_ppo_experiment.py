...
BASELINE_STATS = "results/sweeps/v2_reward/models/vec_normalize.pkl"
...
def parse_args():
    ...
    parser.add_argument("--output-dir", type=str, default="results/reproducible/energy_ppo_from_scratch_time")
