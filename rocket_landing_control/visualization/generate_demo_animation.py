...
def parse_args():
    ...
    parser.add_argument(
        "--trajectory",
        type=str,
        default="results/reproducible/baseline_existing_model_eval_100/success_trajectories.json",
    )
    parser.add_argument("--output", type=str, default="results/reproducible/landing_demo.gif")
