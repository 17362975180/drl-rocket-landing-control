...
def main():
    ...
    parser.add_argument("--input-dir", type=str, default="results/reproducible")
    parser.add_argument("--output-dir", type=str, default="results/reproducible/figures")
    args = parser.parse_args()
    input_dir = Path(args.input_dir)
    output_dir = Path(args.output_dir)

    files = {
        "training": input_dir / "training_curves_data.json",
        "safety": input_dir / "safety_comparison.json",
        "robustness": input_dir / "robustness_full.json",
        "controller": input_dir / "controller_comparison.json",
        "ablation": input_dir / "ablation" / "reward_ablation.json",
        "rl": input_dir / "rl_comparison" / "rl_comparison.json",
    }
