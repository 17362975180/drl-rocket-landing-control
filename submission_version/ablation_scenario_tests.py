...
def evaluate_mode_scenarios(mode, model_path, stats_path, scenarios, n_episodes, seed):
    ...
    for idx, (scenario_name, options) in enumerate(scenarios.items()):
        ...
        representative[scenario_name] = {
            ...
            "comparison_seed": seed + idx * 10_000,
...
def parse_args():
    ...
    parser.add_argument("--source-dir", type=str, default="results/experiments/05_ablation")
    parser.add_argument("--output-dir", type=str, default="results/experiments/05_ablation/scenarios")
