...
def parse_args():
    ...
    parser.add_argument("--output-dir", type=str, default="results/experiments/05_ablation")
...
def main():
    ...
    for i, mode in enumerate(modes):
        ...
        # Training seeds may differ, but every policy is evaluated on the exact
        # same episode seeds so trajectory and metric comparisons are paired.
        summary, rollouts = evaluate_variant(model_path, stats_path, mode, args.n_episodes, args.seed)
